...
const dubai = {
  ...
  itineraries: [
    {
      key: 'best-seller',
      name: 'Dubai Best Seller Package',
      nights: '5N / 6D',
      hotelCategory: 'Dubai City · Burj Khalifa · Desert Safari · Abu Dhabi',
      price: 'USD 450 PP',
      overview:
        'Experience the very best of the UAE with our best-selling 5-night, 6-day Dubai package. From the world’s tallest building and a magical desert safari to the vibrant Global Village and the magnificent Sheikh Zayed Grand Mosque in Abu Dhabi, it blends sightseeing, adventure, culture, shopping and entertainment.',
      bestFor:
        'Ideal for honeymoon couples, families with kids, first-time visitors, friends, small groups and corporate incentive groups.',
      hotels: [
        { name: 'Citymax Hotel Bur Dubai', stars: 3, price: 'USD 450 PP' },
        { name: 'Royal Ascot Hotel', stars: 4, price: 'USD 580 PP' },
        { name: 'Park Regis Kris Krin', stars: 5, price: 'USD 700 PP' },
      ],
      days: [
        {
          day: 1,
          title: 'Welcome to Dubai & Marina Dhow Cruise Dinner',
          desc: 'Arrival at Dubai International Airport with a warm welcome and a comfortable transfer to the hotel. In the evening, sail through Dubai Marina on a traditional Arabian dhow amid illuminated skyscrapers, live entertainment and an international buffet dinner.',
          items: ['Airport pick-up', 'Hotel check-in', 'Dubai Marina Dhow Cruise', 'International buffet dinner', 'Night views of Dubai Marina'],
          overnight: 'Dubai',
        },
        {
          day: 2,
          title: 'Dubai City Tour & Burj Khalifa (124th Floor)',
          desc: 'A half-day city tour through Dubai’s icons — old and modern — followed by the Burj Khalifa, ascending to the 124th-floor observation deck for breathtaking panoramic skyline views.',
          items: ['Dubai City Tour', 'Jumeirah Beach', 'Burj Al Arab (photo stop)', 'Palm Jumeirah', 'Atlantis The Palm', 'Dubai Marina', 'Burj Khalifa – 124th Floor', 'Dubai Fountain area'],
          overnight: 'Dubai',
        },
        {
          day: 3,
          title: 'Desert Safari with BBQ Dinner',
          desc: 'An adventurous afternoon across the golden dunes in a 4x4 — camel rides, henna, Arabic costumes and a traditional campsite — concluding with a BBQ buffet dinner under the stars and live belly dance, Tanoura and fire shows.',
          items: ['Dune bashing', 'Camel ride', 'Sunset photography', 'Henna painting', 'Tanoura show', 'Belly dance', 'Fire show', 'BBQ buffet dinner'],
          overnight: 'Dubai',
        },
        {
          day: 4,
          title: 'Miracle Garden & Global Village',
          desc: 'Two of Dubai’s most colourful attractions — the breathtaking Dubai Miracle Garden with millions of blooming flowers, then the world-famous Global Village with international pavilions, shopping, food and live performances.',
          items: ['Dubai Miracle Garden', 'Floral displays & photo spots', 'Global Village', 'International shopping', 'Cultural shows', 'Food from around the world'],
          overnight: 'Dubai',
        },
        {
          day: 5,
          title: 'Full-Day Abu Dhabi City Tour',
          desc: 'Discover the elegant UAE capital — the magnificent Sheikh Zayed Grand Mosque, then a panoramic tour of the Corniche, Emirates Palace, Qasr Al Watan and Etihad Towers, with a photo stop at Ferrari World on Yas Island.',
          items: ['Sheikh Zayed Grand Mosque', 'Abu Dhabi Corniche', 'Emirates Palace (photo stop)', 'Etihad Towers', 'Qasr Al Watan (photo stop)', 'Ferrari World (photo stop)'],
          overnight: 'Dubai',
        },
        {
          day: 6,
          title: 'Departure',
          desc: 'After breakfast, check out and enjoy a comfortable transfer to Dubai International Airport — departing with unforgettable memories of the UAE.',
          items: ['Breakfast', 'Hotel check-out', 'Private airport transfer'],
          overnight: null,
        },
      ],
      includes: [
        ...
        'Burj Khalifa – At The Top, 124th Floor (non-prime hours)',
        'Desert Safari with BBQ dinner',
        'Dubai Miracle Garden entry',
        'Global Village entry',
        'Full-day Abu Dhabi City Tour',
        'All sightseeing on shared or private basis (as per the package selected)',
        'English-speaking driver/guide during tours',
        'All applicable taxes',
      ],
      excludes: [
        'International & domestic airfare',
        'UAE visa fees',
        'Lunches, dinners & personal expenses (unless specified)',
        'Travel insurance',
        'Tips & gratuities',
        'Anything not listed under Inclusions',
      ],
      whyChoose: [
        'Covers Dubai’s top attractions in one itinerary',
        'Includes a full-day Abu Dhabi excursion',
        'Perfect balance of sightseeing and leisure',
        'Suitable for couples, families, honeymooners & groups',
        'Excellent value with premium attractions included',
        'Private airport transfers & comfortable sightseeing',
      ],
      addOns: [
...
const azerbaijan = {
  ...
  itineraries: [
    {
      key: 'classic',
      name: 'Azerbaijan Classic Tour Package',
      nights: '4N / 5D',
      hotelCategory: 'Baku City · Old City · Absheron · Gobustan',
      price: 'USD 270 PP',
      summary: 'Baku City · Old City · Absheron Peninsula · Gobustan National Park',
      overview:
        'Discover the best of Azerbaijan with our most popular 4-night, 5-day Baku package — a hassle-free, ready-to-sell itinerary. From the charming streets of the UNESCO-listed Old City to the unique mud volcanoes and the famous Burning Mountain, it covers all of Baku’s must-visit attractions.',
      bestFor:
        'Ideal for independent travellers, honeymooners, families, couples and small groups — a balanced mix of sightseeing, history, culture, shopping and leisure.',
      hotels: [
        { name: 'Atlas Hotel Baku', stars: 3, price: 'USD 270 PP' },
        { name: 'Sapphire Inn Hotel (Nizami Street)', stars: 4, price: 'USD 350 PP' },
        { name: 'Boulevard by Marriott Baku', stars: 5, price: 'USD 440 PP' },
      ],
      days: [
        {
          day: 1,
          title: 'Welcome to Baku',
          desc: 'Arrival at Heydar Aliyev International Airport with a warm meet-and-greet by our representative, followed by a comfortable private transfer to the hotel for check-in. The rest of the day is free to relax after the journey or explore the nearby cafés and streets at leisure.',
          items: ['Airport meet & greet', 'Private transfer & hotel check-in', 'Leisure evening'],
          overnight: 'Baku',
        },
        {
          day: 2,
          title: 'Baku City Tour & Old City Experience',
          desc: 'A full day discovering the capital — panoramic views from Highland Park over the Caspian Sea and skyline, the iconic Flame Towers, a stroll along Baku Boulevard and Little Venice, then a step back in time through the historic Old City (Icherisheher), a UNESCO World Heritage Site.',
          items: ['Highland Park', 'Flame Towers', 'Baku Boulevard', 'Little Venice', 'Maiden Tower', 'Palace of the Shirvanshahs', 'Museum of Miniature Books', 'Old City (Icherisheher)', 'Fountain Square', 'National History Museum'],
          overnight: 'Baku',
        },
        {
          day: 3,
          title: 'Absheron Peninsula Tour & Shopping',
          desc: 'Explore the natural wonders of the Absheron Peninsula — the world-famous Ateshgah Fire Temple and Yanar Dag, where natural flames have burned for centuries. Drive past the striking Heydar Aliyev Center and stop at the I LOVE BAKU sign, before an afternoon of shopping at Baku’s modern malls.',
          items: ['Ateshgah Fire Temple', 'Yanar Dag (Burning Mountain)', 'Heydar Aliyev Center (photo stop)', 'I LOVE BAKU sign', 'Shopping at Baku malls'],
          overnight: 'Baku',
        },
        {
          day: 4,
          title: 'Gobustan National Park & Mud Volcano Adventure',
          desc: 'Experience Azerbaijan’s unique natural heritage — the interactive Gobustan 3D Museum, then Gobustan National Park with thousands of prehistoric rock carvings over 40,000 years old, followed by an exciting off-road drive to the famous mud volcanoes.',
          items: ['Gobustan 3D Museum', 'Gobustan National Park', 'Ancient rock carvings', 'Off-road mud volcano experience'],
          overnight: 'Baku',
        },
        {
          day: 5,
          title: 'Departure',
          desc: 'After breakfast, check out from the hotel and enjoy a comfortable private transfer to the airport — leaving Azerbaijan with unforgettable memories.',
          items: ['Breakfast', 'Hotel check-out', 'Private airport transfer'],
          overnight: null,
        },
      ],
      includes: [
        ...
        'Private vehicle throughout the tour (sized to the group)',
        'English-speaking driver',
        'Professional English-speaking guide (groups of 9 guests & above)',
        'Baku City, Old City, Absheron Peninsula & Gobustan National Park tours',
      ...
      entryTickets: [
        ...
        'Off-road vehicle to the mud volcanoes',
      ],
      excludes: [
        'International & domestic airfare',
      ...
      whyChoose: [
        'Best-selling 4-night Azerbaijan package',
        'Covers all major attractions of Baku',
        'Choice of 3★, 4★ and 5★ hotels',
        'Private transfers and sightseeing throughout',
        'Great value — major entry tickets included',
        'Perfect for first-time visitors to Azerbaijan',
      ],
    },
  ],
